...
<template>
  <div class="overflow-y-auto">
    <main class="mx-6 my-10 flex min-h-[80vh] flex-col items-center justify-center gap-9">
      ...
      <form @submit.prevent="handleLogin" class="flex w-full flex-col gap-5 lg:px-12">
        ...
        <div class="flex flex-col gap-4">
          ...
          <div class="flex w-full items-center justify-center">
            <router-link to="/auth/register" class="text-sm text-primary">Create an account</router-link>
          </div>
        </div>
      </form>
    </main>
